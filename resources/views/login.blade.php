    ...
    <div class="flex h-screen">
        ...
        <div class="w-full lg:w-[40%] flex flex-col justify-center px-12 md:px-24 bg-white relative">
            ...
            <div class="max-w-sm w-full mx-auto">
                <header class="mb-12">
                    <span class="text-[10px] font-bold tracking-[0.4em] text-gray-300 uppercase italic">Bienvenue au Studio</span>
                    <h1 class="text-5xl font-extrabold tracking-tighter mt-2 leading-none">Connexion.</h1>
                </header>

                <form class="space-y-10">
                    <div class="flex flex-col">
                        <label class="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2">Identifiant / Email</label>
                        <input type="email" placeholder="chef@foodieshare.com" class="input-flat py-3 text-sm font-medium italic">
                    </div>

                    <div class="flex flex-col">
                        <div class="flex justify-between items-center mb-2">
                            <label class="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400">Mot de passe</label>
                            <a href="#" class="text-[9px] font-bold uppercase text-orange-600 hover:underline">Oublié ?</a>
                        </div>
                        <input type="password" placeholder="••••••••" class="input-flat py-3 text-sm font-medium">
                    </div>
                ...
                <footer class="mt-16 text-center lg:text-left">
                    <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                        Nouveau chef ici ? 
                        <a href="/register" class="text-black hover:text-orange-600 border-b border-black ml-2">Créer un compte</a>
                    </p>
                </footer>
            </div>
        </div>
        ...
        <div class="hidden lg:block lg:w-[60%] relative overflow-hidden bg-gray-100">
            ...
            <div class="absolute bottom-16 left-16 right-16 text-white bg-black/40 backdrop-blur-sm p-8 max-w-md">
                <p class="text-2xl font-black tracking-tight leading-tight italic">"La cuisine est une forme d'art. Partagez votre talent avec le monde."</p>
