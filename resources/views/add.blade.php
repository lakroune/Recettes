...
<head>
    ...
    <style>
        ...
        .btn-black:hover { background: #ea580c; scale: 1.02; }
        .img-grid-preview { display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; margin-top: 10px; }
    </style>
</head>
<body class="text-[#1a1a1a]">
    ...
    <main class="max-w-6xl mx-auto px-6 py-20">
        <header class="mb-16">
            <span class="text-[10px] font-bold tracking-[0.4em] text-orange-600 uppercase italic underline decoration-2 underline-offset-4">Studio de Création</span>
            <h1 class="text-5xl md:text-7xl font-extrabold tracking-tighter leading-none mt-4">Nouveau<br>Chef-d'œuvre.</h1>
        </header>
        ...
        <form class="grid grid-cols-1 lg:grid-cols-12 gap-20">
            ...
            <div class="lg:col-span-7 space-y-16">
                ...
                <section class="space-y-8">
                    <input type="text" placeholder="Titre de la recette..." class="input-flat w-full py-4 text-4xl font-black tracking-tighter">
                    <div class="grid grid-cols-3 gap-10">
                        <div class="flex flex-col"><label class="text-[9px] font-bold uppercase text-gray-400 mb-2">Temps (min)</label><input type="number" class="input-flat py-2 font-bold italic"></div>
                        <div class="flex flex-col"><label class="text-[9px] font-bold uppercase text-gray-400 mb-2">Difficulté</label><select class="input-flat py-2 font-bold italic bg-transparent"><option>Facile</option><option>Moyen</option><option>Expert</option></select></div>
                        <div class="flex flex-col"><label class="text-[9px] font-bold uppercase text-gray-400 mb-2">Calories</label><input type="number" class="input-flat py-2 font-bold italic"></div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div id="ingredientsList" class="space-y-6 mb-6">
                        <div class="flex items-end gap-4">
                            ...
                            <button type="button" class="pb-2 text-gray-300 hover:text-red-500 transition"><i class="fa-solid fa-xmark"></i></button>
                        </div>
                    </div>
                ...
                <section>
                    <h2 class="text-xl font-black uppercase tracking-tighter mb-8 border-b-2 border-black pb-2">Préparation</h2>
                    ...
                    <button type="button" onclick="addStep()" class="text-[10px] font-bold uppercase tracking-[0.2em] text-orange-600 mt-8">+ Ajouter une étape</button>
                </section>

                <div class="pt-10">
                    <button type="submit" class="btn-black w-full shadow-2xl">Publier la recette premium</button>
                </div>
            </div>
            ...
            <div class="lg:col-span-5">
                <div class="sticky top-28 space-y-12">
                    ...
                    <div>
                        <label class="text-[10px] font-bold uppercase tracking-widest text-black mb-4 block">Image Principale (Portrait)</label>
                        <div class="relative group aspect-[3/4] bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden">
                            <input type="file" class="absolute inset-0 opacity-0 cursor-pointer z-10" onchange="previewMain(this)">
                    ...
                    <div>
                        <label class="text-[10px] font-bold uppercase tracking-widest text-black mb-4 block">Galerie Secondaire (Max 4)</label>
                        <div class="grid grid-cols-2 gap-4">
                            <template id="secondaryTemplate">
                                <div class="relative aspect-square bg-gray-50 border border-dashed border-gray-200 flex items-center justify-center overflow-hidden">
                                    <input type="file" class="absolute inset-0 opacity-0 cursor-pointer z-10" onchange="previewSecondary(this)">
                                    <i class="fa-solid fa-plus text-gray-200"></i>
                                    <img class="absolute inset-0 w-full h-full object-cover hidden">
                                </div>
                            </template>
                            
                            <div class="secondary-slot aspect-square bg-gray-50 border border-dashed border-gray-200 flex items-center justify-center overflow-hidden relative">
                                <input type="file" class="absolute inset-0 opacity-0 cursor-pointer z-10" onchange="previewSecondary(this)">
                                <i class="fa-solid fa-plus text-gray-200"></i>
                                <img class="absolute inset-0 w-full h-full object-cover hidden">
                            </div>
